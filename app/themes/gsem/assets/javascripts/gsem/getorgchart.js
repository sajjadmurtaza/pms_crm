...
getOrgChart.prototype._az = function () {
    this._zQ = get._r().msie ? this.element.clientWidth : window.getComputedStyle(this.element, null).width;
    this._zQ = parseInt(this._zQ);
    if (this._zQ < 3) {
        this._zQ = 1024;
        this.element.style.width = "1024px"
    }
    this._zp = get._r().msie ? this.element.clientHeight : window.getComputedStyle(this.element, null).height;
    this._zp = parseInt(this._zp);
    if (this._zp < 3) {
        this._zp = parseInt((this._zQ * 9) / 16);
        this.element.style.height = this._zp + "px"
    }
    this._aV = this._zQ;
    this._aF = this._zp - this.theme.toolbarHeight;
    this.element.innerHTML = getOrgChart.INNER_HTML.replace("[theme]", this.config.theme).replace("[color]", this.config.color).replace(/\[height]/g, this._aF).replace(/\[toolbar-height]/g, this.theme.toolbarHeight)
};
getOrgChart.prototype.changeColorScheme = function (a) {
    if (this.config.color == a) {
        return
    }
    this._Q._zl.className = this._Q._zl.className.replace(this.config.color, a);
    this.config.color = a
};
getOrgChart.prototype._aH = function () {
    ...
    switch (this.config.orientation) {
        ...
        case getOrgChart.RO_LEFT_PARENT_TOP:
            this._a8 = this.config.topXAdjustment + this._a7._zZ;
            this._a9 = this.config.topYAdjustment + this._a7._zW;
            break;
...
getOrgChart.prototype._p = function () {
    ...
    for (var b = 0; b < this._aB.length; b++) {
        ...
        switch (this.render) {
            case"SVG":
                var a = d.getImageUrl();
                var j = parseInt(d._zZ);
                var l = parseInt(d._zW);
...
getOrgChart.prototype.draw = function () {
    ...
    if (this.config.zoomable) {
        this._Q._zD.style.display = "inherit";
        this._Q._zX.style.display = "inherit"
    }
...
getOrgChart.prototype._zr = function (d, b) {
    ...
    for (c = 0; c < this._aB.length; c++) {
        if (this._aB[c].id === d) {
            var a = this._Q._U(this._aB[c]._zZ, this._aB[c]._zW);
...
getOrgChart.prototype._d = function () {
    ...
    if (this.config.zoomable) {
        this._a(this._Q._zX, "click", this._zE);
        this._a(this._Q._zD, "click", this._zC);
...
getOrgChart.prototype._a = function (b, c, d) {
    ...
    if (getOrgChart.util._zA(b.getListenerList, c)) {
        return
    }
    function f(g, h) {
        return function () {
...
getOrgChart._Q.prototype._aJ = function () {
    this._zl = this.element.getElementsByTagName("div")[0];
    var a = this._zl.children;
    this._zj = a[0];
    this._v = a[1];
    this._y = a[2];
    this._5 = a[3]
...
getOrgChart.person.prototype.compareTo = function (b) {
    var a = this;
    if (a === undefined || b === undefined || a._zZ === undefined || a._zW === undefined || b._zZ === undefined || b._zW === undefined) {
        return false
    } else {
        return(a._zZ == b._zZ && a._zW == b._zW)
    }
};
...
getOrgChart.themes = {annabel: {size: [350, 140], toolbarHeight: 46, textPoints: [
...
], box: '<path class="get-box" d="M0 0 L350 0 L350 140 L0 140 Z"/>', text: '<text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>', image: '<image xlink:href="[href]" x="1" y="1" height="138" preserveAspectRatio="xMidYMid slice" width="128"/>'}, belinda: {size: [300, 300], toolbarHeight: 46, textPoints: [
    {x: 40, y: 70, width: 220},
...
], box: '<path class="get-box" d="M0 0 L500 0 L500 220 L0 220 Z"/>', text: '<text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>', image: '<clipPath id="cut-off-bottom"><circle cx="105" cy="65" r="85" /></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#cut-off-bottom)" xlink:href="[href]" x="20" y="-20" height="170" width="170"/>'}, eve: {size: [500, 220], toolbarHeight: 46, textPoints: [
    {x: 10, y: 200, width: 490},
    ...
    {x: 10, y: 115, width: 490},
    {x: 10, y: 140, width: 490}
], box: '<path class="get-box" d="M0 0 L500 0 L500 220 L0 220 Z"/>', text: '<text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>', image: '<image xlink:href="[href]" x="20" y="-20" height="170" preserveAspectRatio="xMidYMid slice" width="170"/>'}, vivian: {size: [500, 220], toolbarHeight: 46, textPoints: [
    {x: 10, y: 200, width: 490},
...
], text: '<text transform="rotate([rotate])"  width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>', image: '<image xlink:href="[href]" x="20" y="0" height="140" preserveAspectRatio="xMidYMid slice" width="350"/>'}};
...
get._w = function (a, c, b, h, j, d) {
    ...
    function f() {
        for (var s in b) {
            var t = getOrgChart.util._zA(["top", "left", "right", "bottom"], s.toLowerCase()) ? "px" : "";
...
get._r = function () {
    ...
    getOrgChart._r = {msie: a.browser == "msie", webkit: a.browser == "webkit", mozilla: a.browser == "mozilla", opera: a.browser == "opera"};
    return getOrgChart._r
};
...
getOrgChart.util._T = function (b, c, a) {
    for (i = 0; i < a.length; i++) {
        if (parseInt(a[i]._zZ) == b && parseInt(a[i]._zW) == c) {
            return a[i]
        }
    }
    return null
...
getOrgChart.util._zA = function (a, c) {
    var b = a.length;
    while (b--) {
        if (a[b] === c) {
            return true
...
getOrgChart.prototype._zg = function (c) {
    ...
    for (label in c.data) {
        d += getOrgChart.DETAILS_VIEW_INPUT_HTML.replace("[label]", label).replace("[value]", c.data[label]);
        h.push(label)
    }
    d += a(h, this._aG);
...
getOrgChart.prototype._h = function (l, a) {
    ...
    var e = getOrgChart.DETAILS_VIEW_INPUT_HTML.replace("[label]", h).replace("[value]", "");
...
getOrgChart.prototype._zE = function () {
    this.zoom(1, true)
};
getOrgChart.prototype._zC = function () {
    this.zoom(-1, true)
};
...
getOrgChart.prototype._ab = function (i) {
    ...
    if (this._zw.found.length) {
        var p = this._zw.found[this._zw.showIndex].node._zZ;
        var q = this._zw.found[this._zw.showIndex].node._zW;
        o[0] = p - (d - f);
        o[1] = q - (c - e);
        o[2] = this._aV;
        o[3] = this._aF;
...
getOrgChart.prototype.createPerson = function (d, g, a) {
    ...
    l._aZ[b] = f;
    for (label in f.data) {
        if (!getOrgChart.util._zA(this._aG, label)) {
            this._aG.push(label)
        }
    }
    return this
